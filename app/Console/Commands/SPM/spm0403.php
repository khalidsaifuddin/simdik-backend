...
class spm0403
{
    static function spm_0403($kode_wilayah, $semester_id){
        $sql_0403 = "
        SELECT
            sekolah.sekolah_id,
        ...
        FROM
            ...
            FROM
                ...
                WHERE
                    ...
                    AND ruang.jenis_prasarana_id = 22 
            ...
            WHERE
                ...
                AND prasarana.jenis_prasarana_id = 22
            GROUP BY
                prasarana.sekolah_id 
        ...
        $fetch = DB::connection('sqlsrv')->select($sql_0403);
